...
export const POPULATIONS = {
  ...
  T4T5:   { label: 'T4 / T5 motion detectors', short: 'T4/T5', neuropils: ['medulla', 'lobula'], neurons: ['t4', 't5', 't4/t5', 't4a', 't4b', 't4c', 't4d', 't5a', 't5b', 't5c', 't5d'], color: '#59bfff', group: 'vision' },
  HSVS:   { label: 'HS / VS optic-flow cells', short: 'HS/VS', neuropils: ['lobula plate'], neurons: ['horizontal system', 'vertical system', 'hs', 'vs', 'hse', 'hsn', 'hss', 'lptc', 'lobula plate tangential'], color: '#4fd1c5', group: 'vision' },
  ...
  KC:     { label: 'Kenyon cells (MB)', short: 'KC', neuropils: ['mushroom body', 'calyx', 'pedunculus'], neurons: ['kenyon', 'kc'], color: '#d98cff', group: 'memory' },
  PAM:    { label: 'PAM dopamine (reward)', short: 'PAM', neuropils: ['gamma-lobe', 'beta-lobe', "beta'-lobe", 'medial lobe'], neurons: ['pam'], color: '#ff7ad9', group: 'valence' },
  PPL1:   { label: 'PPL1 dopamine (punishment)', short: 'PPL1', neuropils: ['alpha-lobe', 'pedunculus', 'vertical lobe'], neurons: ['ppl1'], color: '#7fbf5a', group: 'valence' },
  ...
  NPF:    { label: 'NPF / AKH hunger signalling', short: 'NPF', neuropils: ['superior medial protocerebrum', 'gnathal ganglion'], neurons: ['npf', 'akh', 'neuropeptide f', 'npfp1'], color: '#ffa64d', group: 'state' },
  ...
  OCT:    { label: 'Octopamine arousal', short: 'OA', neuropils: ['superior lateral protocerebrum', 'superior intermediate protocerebrum'], neurons: ['octopamin', 'tyramin', 'oa-', 'oa '], color: '#ffe680', group: 'state' },
